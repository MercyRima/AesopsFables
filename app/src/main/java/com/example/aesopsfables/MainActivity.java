    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      btnFable1.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              startActivity(new Intent(getBaseContext(),TheAssandtheLapdog.class));
          }
      });
      btnFable2.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              startActivity(new Intent(getBaseContext(),TheAsssBrains.class));
          }
      });
      ...
      btnFable4.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              startActivity(new Intent(getBaseContext(),TheAssintheLionsSkin.class));
          }
      });
